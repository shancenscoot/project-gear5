...
@section('content')
    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Tambah Data Pelanggaran</h1>
        </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h5 mb-0 text-gray-800 font-weight-bolder">Tambah Data Pelanggaran</h1><span
                ...
                <form action="{{ route('violations.store') }}" method="POST">
                    @csrf
                    <div class="row mb-4">
                        <label for="inputBiaya" class="col-sm-2 col-form-label">Nama Pelanggaran</label>
                        <div class="col-sm-10">
                            <input type="text" value="{{ old('nama_pelanggaran') }}" name="nama_pelanggaran"
                                class="form-control @error('nama_pelanggaran') is-invalid @enderror" id="inputBiaya"
