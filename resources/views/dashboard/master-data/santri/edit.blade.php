            ...
            <div class="card-body">
                ...
                <form action="{{ route('santri.update', $santri->id) }}" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10"><input type="text" name="nama_santri" class="form-control" id="inputBiaya"
                                placeholder="nama santri..."></div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10"><input type="number" name="nis" class="form-control" id="inputBiaya"
                                placeholder="nis..."></div>
                    </div>
                    <div class="row mb-4">
                        <label for="inputBiaya" class="col-sm-2 col-form-label">Alamat</label>
                        <div class="col-sm-10"><input type="text" name="alamat" class="form-control" id="inputBiaya"
                                placeholder="alamat..."></div>
                    </div>
                    <div class="row mb-4">
                        <label for="inputBiaya" class="col-sm-2 col-form-label">No Telp</label>
                        <div class="col-sm-10"><input type="number" name="no_telp" class="form-control" id="inputBiaya"
