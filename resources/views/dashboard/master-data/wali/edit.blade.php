            ...
            <div class="card-body">
                ...
                <form action="{{ route('wali.update', $wali->id) }}" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{ old('name', $wali->name) }}" name="name"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{ old('username', $wali->username) }}" name="username"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{ old('alamat', $wali->alamat) }}" name="alamat"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="number" value="{{ old('no_telp', $wali->no_telp) }}" name="no_telp"
